...
export default function TransitionSection() {
  return (
    <section className="py-20 relative bg-gradient-to-r from-[#001a3a] via-[#002C5F] to-[#001a3a] overflow-hidden border-t border-b border-[#D4A017]/30 text-white">
      {/* Radial Backlight */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <motion.div
          ...
          className="p-8 sm:p-12 rounded-3xl bg-[#001a3a]/80 border border-[#D4A017]/40 shadow-2xl backdrop-blur-md"
        >
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#D4A017]/20 border border-[#D4A017]/40 text-xs font-bold text-[#D4A017] mb-6">
          ...
          <div className="text-sm font-bold text-[#D4A017] flex items-center justify-center gap-2">
